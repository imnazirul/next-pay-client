...
const AgentDashboard = () => {
    ...
    return (
        ...
        <div onClick={()=> navigate("/request-money")} className="bg-blue-100 border flex-1 max-w-sm py-8 cursor-pointer hover:scale-105 transition-all duration-300 flex justify-center flex-col items-center border-blue-400 rounded-md">
