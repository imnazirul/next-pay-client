    ...
    <div className="container mx-auto">
      <div className="flex justify-between items-center mt-4 bg-blue-50 px-4 py-2 rounded-xl border border-blue-500">
        ...
        <div className="font-medium text-lg">
          {isBalanceShow ? <p className="text-lg bg-blue-500 font-medium px-6 py-1 w-40 rounded-md text-white text-center">Balance: {user?.balance}</p> : <Button isLoading={isBalanceLoading} onClick={handleSeeBalance} className="py-1.5">See Balance</Button>}
        </div>
        <Button className="max-w-40 py-2" isLoading={isLoading} onClick={handleLogout}>
          LogOut
        </Button>
      </div>
    </div>
